...
# Define 20 themes with their corresponding hex color palettes
themes_and_palettes = {
...
def classify_image_theme_and_palette(image_path):
    ...
    # Preprocess image and text (themes)
    ...
    with torch.no_grad():
        ...
        logits_per_image = outputs.logits_per_image  # Similarity score for each theme
        probs = logits_per_image.softmax(dim=1)  # Convert logits to probabilities

    # Get the index of the theme with the highest probability
